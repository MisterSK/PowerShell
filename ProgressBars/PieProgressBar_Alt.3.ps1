function Show-PieProgressBar3 {
    ...
    for ($i = 0; $i -le 100; $i++) {
        ...
        # Alternative 3 - Using span properties directly
        $timeDisplay = "$($timeRemaining.Hours.ToString('D2')):$($timeRemaining.Minutes.ToString('D2')):$($timeRemaining.Seconds.ToString('D2'))"
